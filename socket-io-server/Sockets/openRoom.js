  ...
  dbClient.connect(async (err, client) => {
    ...
    if (!gameData.player1 || !gameData.player2) {
      ...
      if (!gameData.player1) {
        ...
        updatedObj.player1 = { userName: data.player, type: userType, startGame: false };
        gameData.player1 = { userName: data.player, type: userType,startGame: false };
      } else {
        userType = playerTypes.O;
        updatedObj.player2 = { userName: data.player, type: userType, startGame: false };
        gameData.player2 = { userName: data.player, type: userType, startGame: false };
      }
